"""
Django settings for Geeks Andijan IQ Test project.
...
WSGI_APPLICATION = 'geeks_iq.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR / 'iq_test' / 'static']
